...
const simSpeed = 1; // Fixed speed, no user control
...
// appNodes will be populated in init() function

// Fullscreen check will be done in init() function
...
function init() {
	// Initialize Stage instances now that DOM is available
	...
	// Populate appNodes with DOM elements
...
// Initial resize will be called in init() function

// Resize listener will be added in init() function
...
// Audio preloading will be handled in onMounted
function startApp() {
